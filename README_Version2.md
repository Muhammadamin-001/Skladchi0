...
- Botdagi **📱 Ilova** tugmasi Telegram Mini App sifatida ochilishi uchun deploy qilingan web manzilni `WEB_APP_URL` env o'zgaruvchisiga yozing (masalan: `https://example.onrender.com`).
- `WEB_APP_URL` berilmasa, bot ilova tugmasini yashiradi va tasdiqlangan foydalanuvchiga havola hali sozlanmaganini bildiradi.
